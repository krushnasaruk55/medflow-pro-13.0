...
const SECRET_KEY = process.env.HOSPITAL_SECRET_KEY || 'MedFlowPro2025SecretKey_FALLBACK_CHANGE_ME';
...
/**
 * Hash user password for storage (Asynchronous)
 */
...
/**
 * Verify user password (Asynchronous)
 */
